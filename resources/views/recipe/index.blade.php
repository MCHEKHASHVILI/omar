...
<section class="menu-container">
    ...
    <div class="menu-items row m-0 mt-5">
        ...
        <div class="col-md-3 p-1 mt-5">
            <div class="menu-card1">
                <a href="{{ URL(config('constants.RECIPES.VIDEOS_PATH') . Isop::isKeyExists($card, 'id')) }}">
        ...
        @endforeach
        {{Isop::customPagination($totalRecords, $searchKeyword, $currentPage, $recordsPerPage, config('constants.RECIPES.COLLECTION'))}}
    </div>
</section>
