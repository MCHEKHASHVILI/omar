...
<section class="w-100">
 ...
 <button class="top-left-button" onclick="lcoation.href='{{url()->previous()}}'"><i class="fas fa-chevron-left" style="font-size: 15px; margin: 3px;">{{__('messages.back')}}</i> </button>               
<button class="top-left-button" onclick="location.href='/home'">{{__('messages.home')}}</button>
  ...
  <div class="menu-container1">
        ...
        <div class="menu-items row p-0 m-0 mt-5">
            ...
            @foreach ($getCategoryBasedRecipes as $key => $recipe)
            @php
            ...
            <div class="col-md-3 p-1">
                <div class="menu-card1">
                    <a href="{{ URL(config('constants.RECIPES.VIDEOS_PATH') . $id) }}">
                        ...
                        <button class="{{Isop::isKeyExists($recipe, 'difficulty')}}">{{__('messages.'.Str::lower(Isop::isKeyExists($recipe, 'difficulty')))}}</button>
                        <div class="time">
