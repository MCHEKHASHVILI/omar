                ...
                <div class="item col-md-3 col-sm-6">
                    <div class="p-1">
                        <div class="menu-card1 mb-3">
                            <img src="{{asset('assets/images/item2.png')}}" class="menu-img">
                            <h5>Nepali Food</h5>
                            <button>Easy</button>
                            <div class="time">
                                <p class="minute"><span class="min">15</span><br>Min</p>
    ...
    <div class="row mt-5">
        ...
        <div class="menu-items scrollable-div mb-5">
            <div class="menu-card" style="overflow: hidden;">
                <div class="col-md-3 col-sm-6 pt-5 chest-box" data-status="chest-easy">
                    <div class="menu-card1 mb-3">
                        <img src="{{asset('assets/images/item2.png')}}" class="menu-img">
                        <h5>Nepali Food</h5>
                        <button>Easy</button>
                ...
                <div class="col-md-3 col-sm-6 pt-5 chest-box" data-status="chest-hard">
                    <div class="menu-card1 mb-3">
                        <img src="{{asset('assets/images/item2.png')}}" class="menu-img">
                        <h5>Nepali Food</h5>
                ...
                <div class="col-md-3 col-sm-6 pt-5 chest-box" data-status="chest-intermediate">
                    <div class="menu-card1 mb-3">
                        <img src="{{asset('assets/images/item2.png')}}" class="menu-img">
                        <h5>Nepali Food</h5>
        ...
        <div class="menu-items scrollable-div mb-5">
            <div class="menu-card" style="overflow: hidden;">
                <div class="col-md-3 col-sm-6 pt-5 biceps-box" data-status="biceps-easy">
                    <div class="menu-card1 mb-3">
                        <img src="{{asset('assets/images/item2.png')}}" class="menu-img">
                        <h5>Nepali Food</h5>
                        <button>Easy</button>
                ...
                <div class="col-md-3 col-sm-6 pt-5 biceps-box" data-status="biceps-hard">
                    <div class="menu-card1 mb-3">
                        <img src="{{asset('assets/images/item2.png')}}" class="menu-img">
                        <h5>Nepali Food</h5>
                        <button class="hard">Hard</button>
                ...
                <div class="col-md-3 col-sm-6 pt-5 biceps-box" data-status="biceps-intermediate">
                    <div class="menu-card1 mb-3">
                        <img src="{{asset('assets/images/item2.png')}}" class="menu-img">
                        <h5>Nepali Food</h5>
                        <button class="intermediate">Intermediate</button>
        ...
        <div class="menu-items scrollable-div mb-5">
            <div class="menu-card" style="overflow: hidden;">
                <div class="col-md-3 col-sm-6 pt-5 six-pack-box" data-status="six-pack-easy">
                    <div class="menu-card1 mb-3">
                        <img src="{{asset('assets/images/item2.png')}}" class="menu-img">
                        <h5>Nepali Food</h5>
                        <button>Easy</button>
                ...
                <div class="col-md-3 col-sm-6 pt-5 six-pack-box" data-status="six-pack-hard">
                    <div class="menu-card1 mb-3">
                        <img src="{{asset('assets/images/item2.png')}}" class="menu-img">
                        <h5>Nepali Food</h5>
                        <button class="hard">Hard</button>
                ...
                <div class="col-md-3 col-sm-6 pt-5 six-pack-box" data-status="six-pack-intermediate">
                    <div class="menu-card1 mb-3">
                        <img src="{{asset('assets/images/item2.png')}}" class="menu-img">
                        <h5>Nepali Food</h5>
                        <button class="intermediate">Intermediate</button>
        ...
        <div class="menu-items scrollable-div mb-5">
            <div class="menu-card" style="overflow: hidden;">
                <div class="col-md-3 col-sm-6 pt-5 no-equipment-box" data-status="no-equipment-easy">
                    <div class="menu-card1 mb-3">
                        <img src="{{asset('assets/images/item2.png')}}" class="menu-img">
                        <h5>Nepali Food</h5>
                        <button>Easy</button>
                ...
                <div class="col-md-3 col-sm-6 pt-5 no-equipment-box" data-status="no-equipment-hard">
                    <div class="menu-card1 mb-3">
                        <img src="{{asset('assets/images/item2.png')}}" class="menu-img">
                        <h5>Nepali Food</h5>
                        <button class="hard">Hard</button>
                ...
                <div class="col-md-3 col-sm-6 pt-5 no-equipment-box" data-status="no-equipment-intermediate">
                    <div class="menu-card1 mb-3">
                        <img src="{{asset('assets/images/item2.png')}}" class="menu-img">
                        <h5>Nepali Food</h5>
                        <button class="intermediate">Intermediate</button>
